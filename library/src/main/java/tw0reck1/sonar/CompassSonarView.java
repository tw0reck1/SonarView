...
public class CompassSonarView extends RotaryView implements Sonar {
    ...
    public CompassSonarView(Context context) {
        super(context);
        init();
    }

    public CompassSonarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs, 0);
        init();
    }

    public CompassSonarView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawArc(Canvas canvas, float centerX, float centerY, float radius) {
        ...
        final RectF rect = new RectF(centerX, centerY, centerX, centerY);

        float inset = -0.9f * (radius - textSize - mStrokeWidth / 2f);
