...
class StrokeCompassSonarView : RotaryView, Sonar {
    ...
    companion object {
        ...
        private const val DEFAULT_POINT_SIZE = 8f
    ...
    private fun drawArc(canvas: Canvas, centerX: Float, centerY: Float, radius: Float) {
        ...
        val textSize = max(fontSize, thinFontSize)
        val lineLength = 0.9f * (radius - textSize - strokeWidth / 2f)
        val arcPoint = getPointOnCircle(centerX, centerY, lineLength, scannerAngle)
